...
#How to use:
"""
To use with Sören code you need to use the "how_to_connect.py" scheme then in whichever file is 
connecting you can add:
    
from check_cent_align import * 

Then you will have access to all of the functions here. The one that is needed to compare two spectra
for aligning the centrifuge is: 
    
avg_diff_spectrum_data(cent_spectrum: Spectrum, arm_spectrum: Spectrum, use_fit=False, plot=False, generate=False)

this function will need to be integrated into the function that is dealing with each new frame from 
the bus. 

Some changes will need to be implimented because we need to "save" data from when one of the two 
"""
...
def generate_test_data(amplitude=19,sigma=11):
...
############################################################################################
# analyze spectrum 
def estimated_envelope(spectrum_data: Spectrum, plot=False):
    """
...
def avg_diff_spectrum_data(cent_spectrum: Spectrum, arm_spectrum: Spectrum, use_fit=False, plot=False, generate=False):
    """
